...
import { LayoutDashboard, Building2, Users, CalendarDays, Settings, LogOut, Shield, BarChart3 } from "lucide-react"
      ...
      <div className="flex h-full flex-col">
        ...
        <div className="flex h-14 items-center border-b border-sidebar-border px-4">
          <Link href="/admin/dashboard" className="flex items-center gap-2">
            <Logo />
            <span className="text-xs bg-foreground text-background px-1.5 py-0.5 rounded">Admin</span>
          </Link>
        </div>
